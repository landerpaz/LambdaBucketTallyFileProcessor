...
public class TallyManualBC {
	...
	public static void main(String[] args) {
		...
		try {
			TallyManualBC tallyBC = new TallyManualBC();
	...
	//private TallyInputDTO extractDataFromXML(TallyInputDTO tallyInputDTO, S3Object s3object, String key, String bucket) {
		...
		try {
            ...
            doc = builder.parse("/Users/ashokarulsamy/Downloads/SPAK_TALLY_DAY_BOOK__2018-03-09-11-48-30.xml");
